        ...
        div(class = "card",
          ...
          div(class = "card-body",
            ...
            div(class = "hallazgo-item", style = "border-left-color: #d69e2e;",
              "📈 Estimador de razón 21.81× más eficiente que el simple"
            ),
        ...
        div(class = "card-body",
          layout_columns(
            ...
            div(class = "stat-highlight",
              ...
              div(class = "stat-number", "21.81×"),
              div(style = "color: #38a169; font-weight: 700; margin: 8px 0;", "Eficiencia del Estimador de Razón"),
              p(class = "text-muted", style = "font-size: 0.8rem;",
                "La educación materna reduce drásticamente la varianza estimada")
            )
          )
        )
      )
  ...
  nav_panel(
    ...
    div(class = "container-fluid", style = "max-width: 1200px; margin: 0 auto; padding-top: 80px;",
      ...
      layout_columns(
        ...
        div(class = "card",
          div(class = "card-header", style = "background: linear-gradient(135deg, #3182ce, #63b3ed);",
            "⚖️ Eficiencia Metodológica"
          ),
          div(class = "card-body",
            div(class = "hallazgo-item", style = "border-left-color: #3182ce;",
              "<strong>Estimador de razón:</strong> 21.81× más eficiente"
            ),
            div(class = "hallazgo-item",
              "<strong>Covariable clave:</strong> Educación materna predictiva"
            ),
            div(class = "hallazgo-item",
              "<strong>Varianza:</strong> 0.96 (simple) vs 4.40 (razón)"
            ),
            div(class = "hallazgo-item",
              "<strong>Media global:</strong> 273.64 vs 275.34"
            )
          )
        ),
        # Validez
